# ADV Controller Firmware

HC32F460 firmware for controlling the ADV7280 (video decoder) and ADV7391 (video encoder) on GBSC-Pro.

Part of the [GBSC-Pro custom firmware](../README.md) by Brisma.

## Building

This guide explains how to build the firmware using the ARM GCC toolchain on macOS, Linux, and Windows.
